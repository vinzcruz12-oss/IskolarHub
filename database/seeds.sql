...
INSERT IGNORE INTO colleges (university_id, college_name) VALUES
(9, 'College of Engineering and Architecture'),
(9, 'College of Computer Studies'),
(9, 'College of Business Education'),
(9, 'College of Education'),
(9, 'College of Arts');

INSERT IGNORE INTO courses (college_id, course_name) VALUES
(61, 'BS Civil Engineering'),
(61, 'BS Computer Engineering'),
(61, 'BS Electrical Engineering'),
(61, 'BS Electronics Engineering'),
(61, 'BS Mechanical Engineering'),
(61, 'BS Architecture');

INSERT IGNORE INTO courses (college_id, course_name) VALUES
(62, 'BS Computer Science'),
(62, 'BS Information Technology');

INSERT IGNORE INTO courses (college_id, course_name) VALUES
(63, 'BS Accountancy'),
(63, 'BS Business Administration'),
(63, 'BS Entrepreneurship');

INSERT IGNORE INTO courses (college_id, course_name) VALUES
(64, 'Bachelor of Secondary Education');
...
INSERT IGNORE INTO colleges (university_id, college_name) VALUES
(10, 'School of Civil, Environmental and Geological Engineering'),
(10, 'School of Electrical, Electronics and Computer Engineering'),
(10, 'School of Information Technology'),
(10, 'School of Architecture, Industrial Design and the Built Environment'),
(10, 'E.T. Yuchengco School of Business');

INSERT IGNORE INTO courses (college_id, course_name) VALUES
(66, 'BS Civil Engineering'),
(66, 'BS Environmental and Sanitary Engineering'),
(66, 'BS Geological Engineering');

INSERT IGNORE INTO courses (college_id, course_name) VALUES
(67, 'BS Computer Engineering'),
(67, 'BS Electrical Engineering'),
(67, 'BS Electronics Engineering');

INSERT IGNORE INTO courses (college_id, course_name) VALUES
(68, 'BS Computer Science'),
(68, 'BS Information Technology'),
(68, 'BS Information Systems'),
(68, 'BS Data Science'),
(68, 'BS Cybersecurity');

INSERT IGNORE INTO courses (college_id, course_name) VALUES
(69, 'BS Architecture'),
(69, 'BS Industrial Design'),
(69, 'BS Interior Design');

INSERT IGNORE INTO courses (college_id, course_name) VALUES
(70, 'BS Accountancy'),
(70, 'BS Business Administration'),
(70, 'BS Entrepreneurship');
...
'Academic scholarship granted to students who demonstrate outstanding academic performance.',
'Technological Institute of the Philippines',
'All Programs',
'Academic',
NULL,
'Must satisfy the academic scholarship requirements prescribed by the University.',
NULL,
'https://tip.edu.ph/be-a-tip-ian/tip-scholarships'
),

(
'TIP Entrance Scholarship',
'Entrance scholarship awarded to qualified incoming freshmen.',
'Technological Institute of the Philippines',
'All Programs',
'Entrance',
NULL,
'Must satisfy the entrance scholarship requirements prescribed by the University.',
NULL,
'https://tip.edu.ph/be-a-tip-ian/tip-scholarships'
),

(
'TIP Academic Distinction Award',
'Academic distinction award granted to students with outstanding academic achievement.',
'Technological Institute of the Philippines',
'All Programs',
'Academic',
NULL,
'Must satisfy the academic distinction award requirements prescribed by the University.',
NULL,
'https://tip.edu.ph/be-a-tip-ian/tip-scholarships'
),

(
'TIP Alumni Scholarship',
'Scholarship granted to qualified dependents of TIP alumni.',
'Technological Institute of the Philippines',
'All Programs',
'Academic',
NULL,
'Must satisfy the alumni scholarship requirements prescribed by the University.',
NULL,
'https://tip.edu.ph/be-a-tip-ian/tip-scholarships'
),

(
'TIP Athletic Scholarship',
'Scholarship granted to students who represent the University in athletic competitions.',
'Technological Institute of the Philippines',
'All Programs',
'Athletic',
NULL,
'Must qualify under the University athletic scholarship program.',
NULL,
'https://tip.edu.ph/be-a-tip-ian/tip-scholarships'
),

(
'TIP Cultural Scholarship',
'Scholarship granted to students with outstanding talent in arts and culture.',
'Technological Institute of the Philippines',
'All Programs',
'Cultural',
NULL,
'Must qualify under the University cultural scholarship program.',
NULL,
'https://tip.edu.ph/be-a-tip-ian/tip-scholarships'
),

(
'TIP Student Assistantship Program',
'Financial assistance through student assistantship opportunities within the University.',
'Technological Institute of the Philippines',
'All Programs',
'Assistantship',
NULL,
'Must qualify under the University student assistantship program.',
NULL,
'https://tip.edu.ph/be-a-tip-ian/tip-scholarships'
), -- Added missing comma here
...
(
'E.T. Yuchengco Scholarship',
'This scholarship is a merit-based program for incoming college freshmen students who demonstrate strong academic performance and meet the required criteria.',
'Mapúa University',
'All Programs',
'Academic',
NULL,
'Incoming freshman; must satisfy the scholarship eligibility requirements including the required MPASS score or qualifying academic performance.',
NULL,
'https://www.mapua.edu.ph/pages/admissions/mapua-scholarships'
),

(
'A.T. Yuchengco Scholarship',
'This scholarship is a merit-based and financial-assistance program intended for incoming freshman students who are graduates of recognized Public Science High Schools and who demonstrate both academic excellence and financial need.',
'Mapúa University',
'All Programs',
'Financial Assistance',
NULL,
'Graduate of a recognized Public Science High School; approved IBFAP grantee; incoming freshman; must satisfy the required MPASS score.',
NULL,
'https://www.mapua.edu.ph/pages/admissions/mapua-scholarships'
),
...
'The Don Tomas Mapúa Scholarship for Undergraduate is a merit-based program awarded to academically outstanding students who exemplify excellence, leadership potential, and strong commitment to their studies.',
'Mapúa University',
'All Programs',
'Academic',
NULL,
'Incoming freshman with Highest Honors; graduated from a batch of at least 60 students; must have taken the MPASS.',
NULL,
'https://www.mapua.edu.ph/pages/admissions/mapua-scholarships'
),
...
(
'Academic Scholarship',
'Academic scholarship awarded to students who achieve outstanding academic performance in accordance with the University scholarship policies.',
'Mapúa University',
'All Programs',
'Academic',
NULL,
'Must satisfy the University academic scholarship requirements.',
NULL,
'https://www.mapua.edu.ph/pages/admissions/mapua-scholarships'
),
...
'Financial assistance program for qualified students with demonstrated financial need.',
'Mapúa University',
'All Programs',
'Financial Assistance',
NULL,
'Must satisfy the financial assistance eligibility requirements of the University.',
NULL,
'https://www.mapua.edu.ph/pages/admissions/mapua-scholarships'
),
...
(
'Athletic Scholarship',
'Scholarship granted to qualified student-athletes who represent the University.',
'Mapúa University',
'All Programs',
'Athletic',
NULL,
...
(
'FAMIT, MITLU, Non-FAMIT/Non-MITLU Scholarship',
'Scholarship administered under the University scholarship program for qualified applicants.',
'Mapúa University',
'All Programs',
'Academic',
NULL,
'Must satisfy the scholarship requirements prescribed by the University.',
NULL,
'https://www.mapua.edu.ph/pages/admissions/mapua-scholarships'
),

(
'The New Builder and Mapúa Cardinal Singers Scholarship',
'Scholarship granted to qualified members of The New Builder and the Mapúa Cardinal Singers.',
'Mapúa University',
'All Programs',
'Cultural',
NULL,
